    ...
    <section className="flex flex-col justify-center items-center  mt-24  lg:flex-row  lg:relative lg:overflow-hidden h-screen">
      <div className="lg:flex lg:w-[80%] overflow-hidden">
        <article className="relative lg:static  flex justify-center overflow-hidden px-4 lg:order-2 lg:w-[50%] ">
          ...
          />
          <div className="w-[100%] h-[75%] lg:h-[60%] absolute bottom-0 right-[-18%] lg:right-[-65%] ">
            <LayerBook />
          </div>
        </article>

        <article className=" text-center my-8 lg:order-1 lg:text-start  lg:w-[50%] ">
          <h2 className="font-bold text-3xl text-blue-darker lg:text-[3.3rem] lg:leading-[4rem]">
